...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<railties>.freeze, ["< 5.1", ">= 4.0.0"])
      s.add_runtime_dependency(%q<sprockets>.freeze, [">= 3.5.2"])
      ...
      s.add_dependency(%q<railties>.freeze, ["< 5.1", ">= 4.0.0"])
      s.add_dependency(%q<sprockets>.freeze, [">= 3.5.2"])
