  ...
  render() {
    return (
      <span>
        <Headroom>
        <Row>
          <Col xs={4} xsOffset={0} sm={3} smOffset={1} md={3} mdOffset={1}>
            <a href="/"><Image width="100rem" src="/assets/cartoonMe.png" circle /></a>
          </Col>
          <Col className="pull-right" xs={8} xsOffset={0} sm={5} smOffset={2} md={4} mdOffset={3} lg={4} lgOffset={4} style={{ marginTop: "3rem" }}>
